...
export default function StudentDashboard() {
  ...
  const [faculties] = React.useState([
    ...
    { id: 3, name: "Dr. Riyaz Ahamed", subject: "Income Tax" },
    { id: 3, name: "Prof. Safi", subject: "Data Analytics" },
  ]);
          ...
          <Dialog open={openAssignFaculty} onClose={() => setOpenAssignFaculty(false)}>
            ...
            <DialogContent>
              <Typography variant="body1" sx={{ mb: 2 }}>
                Assign a faculty to {selectedStudent?.firstName} {selectedStudent?.lastName}.
              </Typography>
              <Select
                fullWidth
